      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="rowGroup">
          ...
          <div className="inline">
            <span className="question" title="Add the mortgage you need to pay">
              ?
            </span>
        ...
        <div className="rowGroup">
          ...
          <div className="inline">
            <span
              className="question"
              title="Add the length of time it takes to pay off a mortgage in full in years"
            >
              ?
            </span>
        ...
        <div className="rowGroup">
          ...
          <div className="inline">
            <span
              ...
              title="Add how often you will make a payment"
            >
              ?
            </span>
            <select
        ...
        <div className="rowGroup">
          ...
          <div className="inline">
            <span
              className="question "
              title="The length of the mortgage term from your bank"
            >
              ?
            </span>
